    ...
    <div class="container">
        ...
        <div id="img" class="col-12 mt-5">
            ...
            <div class="col-12 col-md-12 text-center mt-5">
                ...
                @if(Auth::check())
                <h3 class="text-center">ようこそ、<strong class="h2">{{ Auth::user()->name }}</strong>さん</h3>
                <br>
                <a class="btn btn-danger p-2" href="{{ route('company.logout') }}" id="logout" class="my-navbar-item">ログアウト</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="contaiber-fluid">
                            <div class="col-sm-12 mb-2"> <a href="{{ route('home', \Auth::id()) }}" type="button" class="btn btn-secondary btn-lg btn-block">手配者</a></div>
                            <div class="col-sm-12 mb-2"> <a href="{{ route('creator.login', \Auth::id()) }}" type="button" class="btn btn-secondary btn-lg btn-block">制作者</a></div>
                            <div class="col-sm-12 mb-1"> <a href="{{ route('admin.login', \Auth::id()) }}" type="button" class="btn btn-outline-danger btn-lg btn-block">管理者</a></div>
                        </div>
                    </div>
