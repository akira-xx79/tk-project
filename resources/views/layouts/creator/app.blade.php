    ...
    <header>
        <nav class="col-12 navbar navbar-expand-lg navbar-light bg-success">
            ...
            <div class="d-none d-md-block">
                <form class="form-inline" method="GET" action="../production/search">
            ...
            <div class="d-block d-md-none col-12">
                <form class="form-inline" method="GET" action="../production/search">
                    <div class="form-group mx-sm-3">
                        <input class="form-control" type="text" name="keyword" size="23" placeholder="製番/会社名/製品名">
                    </div>
                    <button class="btn btn-primary mb-3 ml-1" type="submit">Search</button>
                </form>
            </div>
...
<div class="row d-block d-md-none" style="width: 100%;">
<div class="col-5">
<a class="navbar-brand text-white " href="{{ url('/topLogin') }}">
   <span class="text-dark font-weight-bold">SEAM</span> 制作者</a>
</div>
...
@if(Auth::check())
       <span class="my-navbar-item text-white ml-auto">{{ Auth::user()->name }}さん</span>
        ｜
        <a href="#" id="logout" class="my-navbar-item">ログアウト</a>
        <form id="logout-form" action="{{ route('creator.logout') }}" method="POST" style="display: none;">
          @csrf
...
<form class="form-inline" method="GET" action="../production/search">
    <input class="form-control ml-2" type="text" name="keyword" size="25" placeholder="製番/会社名/製品名">
     <span><button class="btn btn-primary mb-3 ml-2" type="submit">Search</button></span>
  </form>
</div>
</div>
</div> -->
...
<nav class="bottom-sticky-nav fixed-bottom" style="width:100%">
    <ul>
        <li style="width:25%">
            <a class="px-0 m-auto" href="{{ route('creator.prodcto.all') }}"><i class="fa fa-home"></i><img src="/storage/images/タスクがいっぱいのタスクトレイのアイコン.png" alt=""><span class="p-1">受注案件</span></a>
        </li>
        <li style="width:25%">
            <a class="px-0 m-auto" href="{{ route('creator.complete.all') }}"><i class="fa fa-user"></i><img src="/storage/images/チェックボックスアイコン.png" alt=""><span class="p-1">完成品</span></a>
        </li>
        <li style="width:25%">
            <a class="px-0 m-auto" href="{{ route('creator.calendar') }}"><i class="fa fa-briefcase"></i><img src="/storage/images/スケジュールカレンダーのアイコン素材.png" alt=""><span class="p-1">カレンダー</span></a>
        </li>
        <li style="width:25%">
            <a class="px-0 m-auto" href="{{ route('creator.supply.All') }}"><i class="fa fa-laptop"></i><img src="/storage/images/フォークリフトアイコン2.png" alt=""><span class="p-1">支給材</span></a>
        </li>
