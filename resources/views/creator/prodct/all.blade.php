...
<div class="col-12 col-md-10 d-none d-md-block">
        ...
        　<table class="table">
            <thead class="thead-dark">
                ...
                <tr class="bg-white">
                    ...
                    <td><span class="label {{ $data->completed_class }}">{{ $data->completed }}</span></td>
                    <td>
                        ...
                        @endif
                        <!-- <a href="/creator/productio/{{ $data->id }}/complete" class="btn btn-success btn-sm">完了</a> -->
                    </td>
                </tr>
                @endforeach
            </thead>
      ...
      <div class="col-12 d-block d-md-none mt-3" id="mobile"><h4>受注一覧</h4></div>
